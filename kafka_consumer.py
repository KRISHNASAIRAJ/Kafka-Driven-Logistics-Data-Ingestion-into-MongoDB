...
# MongoDB Setup
client = MongoClient(
    "mongodb+srv://krishnasairaj:*******************@cluster1.katgqk9.mongodb.net/?retryWrites=true&w=majority"
)#URL Of the MongoDB Server
db = client["truck_data"]#Database name
collection = db["logistics_data"]#Collection name
consumer.subscribe(["truck_data"])  # Consumer object is subscribing to kafka topic
try:
    while True:
